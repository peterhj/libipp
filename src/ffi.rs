...
extern "C" {
  ...
  pub fn ippiResizeLinear_8u_C1R(src: *const u8, src_pitch: i32, dst: *mut u8, dst_pitch: i32, dst_offset: IppiPoint, dst_size: IppiSize, spec: *const IppiResizeSpec_32f, buf: *mut u8) -> IppStatus;
}
